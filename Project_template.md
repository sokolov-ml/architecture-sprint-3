...
- Предоставление другим пользователям доступа к управлению устройствами в своих помещениях
...
- Управление правилами тарификации
- Учёт потребляемых услуг
- Выставление счетов на оплату
- Взаимодействие с внешними платёжными сервисами
- Регистрация фискальных документов
...
Искренне считаю "официальное" определение второго уровня модели C4 совершенно бестолковым, но я попытался. Диаграмма C2 превратилась в перегруженную и уже непонятную для бизнеса. Диаграмма С3 вообще бесполезная. Никто этим пользоваться бы не стал, зато "правильно". Прошлые версии были полезнее.
